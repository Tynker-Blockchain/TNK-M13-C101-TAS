...
class Wallet():
    ...
    def getTransactions(self, address):
        ...
        # Combine the transactions ans save them in allUserTnx
        allUserTnx = asSender + asReceiver
        
        # Sort the combined transactions by the 'time' field
        allUserTnx = sorted(allUserTnx, key=lambda txn: txn.get('time', 0), reverse=True)  # Replace 'time' with your actual timestamp field name
